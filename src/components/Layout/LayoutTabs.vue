<template>
    <div class="mr-2 mt-2 ml-2 flex flex-row rounded-md p-1">
        <div class="mr-2 flex flex-none items-center justify-start">
            <span
                v-for="item in multiTags"
                class="border-lighrBorder mr-4 transform rounded-md transition hover:scale-110"
            >
                <n-tag
                    v-if="getTab"
                    closable
                    ...
                    :class="[
                        'pl-4 pr-4 border-opacity-25 bg-gray-400 bg-opacity-10 dark:border-gray-300 dark:border-opacity-25 dark:bg-gray-300 dark:bg-opacity-10',
...
import { Refresh, Close, CloseCircle, ChevronDown } from "@vicons/ionicons5"
